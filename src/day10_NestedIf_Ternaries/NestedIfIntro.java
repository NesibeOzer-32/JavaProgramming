...
public class NestedIfIntro {
    public static void main(String[] args) {
        ...
        if(hasId){ // if the person has an ID- kimlikle yaş doğrulamak için kimlik de şart
        ...
        // 1 <= number <= 7
        if(number >= 1 && number<= 7){ // if the number is a valid number (1~7) 1 haftada 7 gun var sayı bu sayılardan verilmeli
