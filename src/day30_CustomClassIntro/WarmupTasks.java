...
public class WarmupTasks {
    public static void main(String[] args) {
        ...
        //kac adet 0 var 1. yol
        int freuency= Collections.frequency(list,0);
        System.out.println("freuency = " + freuency);
