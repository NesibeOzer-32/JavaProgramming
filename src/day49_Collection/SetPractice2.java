...
public class SetPractice2 {
    public static void main(String[] args) {
        ...
        /*
        //Hashset output:set1 = [Paper towels, Wooden Spoon, Coke, Eggs, Book, Phone, Pen, Milk]
        //not duplicated, random list
        ...
        //if you want first element first order and last element last order
